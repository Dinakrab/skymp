#include <DX11TextRenderHandler.hpp>
...
namespace CEFUtils {
DX11TextRenderHandler::DX11TextRenderHandler(
...
DX11TextRenderHandler::~DX11TextRenderHandler() = default;

void DX11TextRenderHandler::Render()
{
...
void DX11TextRenderHandler::Reset()
{
  Create();
  _text->Reset();
}

void DX11TextRenderHandler::Create()
{
...
/////////////////////////////////////////////////////////////////////////////
  ...
  _text.reset(new SimpleText(L"Text", m_pRenderer));
}

void DX11TextRenderHandler::GetViewRect(CefRefPtr<CefBrowser> browser,
                                    CefRect& rect)
{
...
void DX11TextRenderHandler::OnPaint(CefRefPtr<CefBrowser> browser,
...
void DX11TextRenderHandler::GetRenderTargetSize()
{
...
void DX11TextRenderHandler::CreateRenderTexture()
{
